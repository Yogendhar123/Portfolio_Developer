      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#915EFF]'>Yogendhar</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>

            I develop responsive UIs and web applications using React js and Angular, ensuring seamless experiences across devices. With over 3 years of experience, I deliver efficient, scalable solutions that meet client needs

          </p>

          <div style={{ display: "flex", alignContent: "center", gap: "12px", marginTop: "35px" }}>
            <div
            ...
            >
              <img src={githubLOgo} alt="" style={{
                ...
                onMouseEnter={(e) => {
                  ...
                  e.target.style.background = "-webkit-linear-gradient(-90.13deg, #00cea8 1.9%, #bf61ff 97.5%)"; // Gradient on hover
                }}
                onMouseLeave={(e) => {
            ...
            >
              <img src={linkIN} alt=""
                ...
                onClick={() => {
                  ...
                  window.open(" https://in.linkedin.com/in/yogendhar ", "_blank");
